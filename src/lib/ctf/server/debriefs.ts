...
const DEBRIEFS: Record<string, string> = {
  ...
  "m1-1": "Airship VII. Aether-coil, nightshade, and one passenger travelling as cargo.\n\nThe Meridian is not a new company. It is the same company with the plate polished, running the same freight to the same dock, and it is still moving people who do not want to be counted.",
  "m1-2": "Signed as C. Vane.\n\nShe is alive, she is in Brasshaven, and she is signing her own name to Meridian paperwork. Either she is working for them or she wants somebody to notice she is not.",
  "m1-3": "The clerk added nothing. Somebody standing behind him did.\n\nWhoever watermarked that note wanted it traceable -- and the only reason to trace a note is to find out which copy leaks. You are being watched by someone who expects you to read this.",
  "x1-1": "The drums remember everything, and nothing in them is indexed. That is the only reason anyone is still at liberty.\n\nWhoever wrote these field notes knew the engine would outlive them, and wrote for whoever broke the key afterwards. That is you.",
  "x1-2": "Small primes, small secrets.\n\nThe Meridian's engineers built their own cryptography to save money on brass. It held for exactly as long as nobody with a difference engine and an afternoon cared enough to look.",
  "x2-2": "An operator in a hurry, a drum that never advanced, and two messages that undo each other.\n\nThe drum room countersign was in the second transmission all along -- protected by nothing but the assumption that nobody would ever hold both halves at once. You are holding both halves.",
}
